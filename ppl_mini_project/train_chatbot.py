...
# lemmaztizing and lowering each word and removing duplicates from each word
...
# classes => is nothing but intents
...
for doc in documents:
    ...
    bag = []   # list of tokenized words for the pattern
    pattern_words = doc[0]
...
# shuffling the features and turning it into array
...
# Creating model with 3 layers. First layer 128 neurons, second layer 64 neurons and 3rd output layer contains number of neurons
