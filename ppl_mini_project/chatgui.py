...
SendButton = Button(base, font=("Verdana",12,'bold'), text="Send", width=10, height=2,
                    bd=0, bg="#df96fa", activebackground="#d362fc",fg='#3d0823',
                    command= send )
...
#Placing all the components on to the screen
scrollbar.place(x=376,y=6, height=386)
ChatLog.place(x=6,y=6, height=386, width=370)
SendButton.place(x=270, y=401, height=50)
EntryBox.place(x=6, y=401, height=50, width=265)
